...
- The hero drop uses a tapered bead, a visible wet track, and traveling satellite beads so the slide reads as flow along the leaf rather than a horizontal teleport.
